...
import { OrderDoc, OrderItemDoc } from '../lib/types';
...
export const RequestsList = () => {
  ...
  const { data: orders, loading: ordersLoading, error: ordersError } =
    useApiResource<OrderDoc>(() => api.orders.list(), []);
  const { data: orderItems, loading: itemsLoading } =
    useApiResource<OrderItemDoc>(() => api.orderItems.list(), []);

  const requestsData = useMemo<RequestRow[]>(() => {
