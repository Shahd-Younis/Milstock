...
export const LoginPageAr = () => {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#F6F3E7] flex">
      <div className="hidden lg:flex flex-1 bg-[#2E3A24] text-white p-12 flex-col justify-between">
        ...
        <div className="max-w-lg space-y-4">
          <h1 className="text-4xl font-bold leading-tight">إدارة مخزون غذائي حقيقي من MongoDB</h1>
          <p className="text-[#E0E1B7] leading-8">
            تابع الأرز، المعكرونة، السكر، الحليب، الخضروات، الفواكه، والمياه عبر المستودعات والطلبات.
          </p>
        </div>
        <p className="text-xs text-[#E0E1B7]/50">© 2026 MilStock</p>
      </div>
      ...
      <div className="w-full lg:w-[480px] flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-white border border-[#4E4631]/10 rounded-2xl shadow-sm p-8">
          <div className="mb-8 text-right">
            <div className="w-12 h-12 rounded-xl bg-[#4B5B3A] flex items-center justify-center mb-4">
