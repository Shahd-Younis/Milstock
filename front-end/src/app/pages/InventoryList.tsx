...
type InventoryStatus = 'in-stock' | 'low-stock' | 'out-of-stock' | 'expiring-soon';
...
export const InventoryList = () => {
  ...
  const inventoryData: InventoryRow[] = products.map((product) => ({
    ...
    status: getProductStatus(product) as InventoryStatus,
  }));
  ...
  const columns = [
    ...
    { key: 'category', header: 'Category' },
    {
      key: 'quantity',
      header: 'Quantity',
      render: (row: InventoryRow) => `${row.quantity} ${row.unit}`,
    },
